...
<%
	...
	*/
	...
	Cookie c1 = CookieBox.createCookie("name", "소종원");
	response.addCookie(c1);
	
	/* Cookie c2 = new Cookie("id","Arin"); */
	/* c2.setMaxAge(60); 1분짜리 쿠키 */
	Cookie c2 = CookieBox.createCookie("nickname","Arin", 60*30);
	response.addCookie(c2);
	
	/* Cookie c3 = new Cookie("man","jjong");
	c3.setMaxAge(60*60); //1시간짜리 쿠키 */
	Cookie c3 = CookieBox.createCookie("pw", "7934", 60*60*2);
...
<body>
	<h1>쿠키를 생성했습니다.</h1>
	<a href="viewCookie2.jsp">viewCookie2</a> <br>
	<a href="viewCookiesjs.jsp">viewCookiejs</a> <br>
</body>
</html>