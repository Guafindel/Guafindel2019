		...
		<div class="container">
			...
			<form id="regForm" method="post" enctype="multipart/form-data">
				<div class="form-group">
					...
					<input type="text" id="gId" class="form-control" name="gId"
				...
				<div class="form-group">
					...
					<input type="text" id="gPw" class="form-control" name="gPw"
					 placeholder="비밀번호를 입력하세요" required>
				</div>

				<div class="form-group">
					<label for="gName">이름</label> 
					<input type="text" id="gName"class="form-control" name="gName"
					 palceholder="이름을 입력하세요" required>
				</div>
