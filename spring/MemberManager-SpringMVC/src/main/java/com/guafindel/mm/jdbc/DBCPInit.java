...
public class DBCPInit extends HttpServlet {
	...
	private void initConnectionPool() {
		...
		try {
			...
			String jdbcDriver = "jdbc:mysql://localhost:3306/guafindel_db?useUnicode=true&characterEncoding=utf-8&serverTimezone=UTC";
			//String username = "scott";
			String username = "guafindel";
			//String pw = "tiger";
			String pw = "admin";
