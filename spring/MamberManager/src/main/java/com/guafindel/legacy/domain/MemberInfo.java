...
public class MemberInfo {
	...
	// 접근제어 지시자 private
		...
		public MemberInfo(String mId, String mPw, String mName, MultipartFile mPhoto) {
			super();
			this.mId = mId;
			this.mPw = mPw;
			this.mName = mName;
		...
		public MemberInfo(int idx, String mId, String mPw, String mName, MultipartFile mPhoto, Date regDate) {
			super();
			this.idx = idx;
			this.mId = mId;
			this.mPw = mPw;
		...
		public long getFileSize() {
			return mPhoto.getSize();
		}
		
		public String getFileName() {
			return mPhoto.getOriginalFilename();
		}
}
